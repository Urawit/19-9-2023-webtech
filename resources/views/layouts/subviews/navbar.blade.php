    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div class="items-center justify-between w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
            <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                ...
                <li>
                    <a href="{{ route('songs.index') }}" class="nav-menu {{ Route::currentRouteName() === 'songs.index' ? 'active' : '' }}">
                        Song List
                    </a>
                </li>
                <li>
                    <a href="{{ route('artists.index') }}" class="nav-menu {{ Route::currentRouteName() === 'artists.index' ? 'active' : '' }}">
                        Artists
                    </a>
                </li>
                <li>
                    <a href="{{ route('about.index') }}" class="nav-menu {{ Route::currentRouteName() === 'about.index' ? 'active' : '' }}">
                        About
                    </a>
                </li>
                <li>
                    <a href="{{ route('playlists.index') }}" class="nav-menu {{ Route::currentRouteName() === 'playlists.index' ? 'active' : '' }}">
                        My Playlist
                    </a>
                </li>
            </ul>
