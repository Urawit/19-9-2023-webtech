    ...
    <div class="bg-white p-10 rounded-lg shadow md:w-3/4 mx-auto lg:w-1/2">
        <form action="{{ route('playlists.update', ['playlist' => $playlist]) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                @enderror
                <input type="text" id="name" name="name" value="{{ $playlist->name }}" autocomplete="off" placeholder="Put in playlist name" class="border border-gray-300 shadow p-3 w-full rounded mb-">
            </div>
